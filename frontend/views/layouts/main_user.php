...
//                    ],
                ...
                [
                    'label' => 'Новая заявка',
                    'url' => '#',
                    'visible' => (!\yii::$app->user->isGuest && $this->context->id == "ticket"),
                    'linkOptions' => [
                        'id' => 'testLink',
                        'onClick' => "javascript: $('#ticket-content').attr('src', '" . \yii::$app->urlManager->createUrl('/ticket/create') . "'); $('#myModal').modal('show');",
                    ],
                ],
