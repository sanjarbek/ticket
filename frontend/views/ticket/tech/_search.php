...
<div class="ticket-search">
    ...
    <?php
    echo $form->field($model, 'created_user')
        ->dropDownList(common\models\Ticket::getCreatedUsersList(), [
            'prompt' => 'Выберите автора заявки...'
    ]);
    ?>
    <?php
...
//        'language' => 'ru',
//        'size' => 'sm',
//        'data' => array_merge(["" => ""], common\models\Ticket::getCategoriesList()),
////        'options' => ['placeholder' => 'Выберите автора заявки ...'],
//        'pluginOptions' => [
//            'allowClear' => true
//        ],
